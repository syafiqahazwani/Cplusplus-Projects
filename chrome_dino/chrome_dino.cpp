...
void moveDino(int jump = 0) {
    ...
    gotoxy(dinoPos, 16 - dinoY);cout<<"         UUBUUUUUU";
    gotoxy(dinoPos, 17 - dinoY);cout<<"         UUUUUUUUU";
    gotoxy(dinoPos, 18 - dinoY);cout<<"         UUUUUUBBB";
    gotoxy(dinoPos, 19 - dinoY);cout<<"U       UUUUUUBBB ";
    gotoxy(dinoPos, 20 - dinoY);cout<<"UUU    UUUUUUUUUU ";
    gotoxy(dinoPos, 21 - dinoY);cout<<"BUUUUUUUUUUUUUU B ";
    gotoxy(dinoPos, 22 - dinoY);cout<<"  BUUUUUUUUUB     ";
